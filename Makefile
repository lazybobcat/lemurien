...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Tue Jan 8 13:51:59 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/Lemurien1.0.0/ && $(COPY_FILE) --parents mainwindow.h databasemanager.h factory.h sqlmodel.h sqlmodelfactory.h song.h config.h playlist.h sidebar.h playlisttablemodel.h addfileswindow.h exceptions/sqlexception.h exceptions.h exceptions/sqldatabaseexception.h exceptions/sqldatanotfoundexception.h exceptions/sqlinsertfailedexception.h exceptions/logicalfaultexception.h editsongwindow.h unsavabeplaylist.h webkitwindow.h .obj/Lemurien1.0.0/ && $(COPY_FILE) --parents main.cpp databasemanager.cpp sqlmodelfactory.cpp sqlmodel.cpp song.cpp config.cpp playlist.cpp sidebar.cpp mainwindow_ui.cpp mainwindow_behaviors.cpp playlisttablemodel.cpp addfileswindow.cpp exceptions/sqlexception.cpp exceptions/sqldatabaseexception.cpp exceptions/sqldatanotfoundexception.cpp exceptions/sqlinsertfailedexception.cpp exceptions/logicalfaultexception.cpp editsongwindow.cpp webkitwindow.cpp .obj/Lemurien1.0.0/ && (cd `dirname .obj/Lemurien1.0.0` && $(TAR) Lemurien1.0.0.tar Lemurien1.0.0 && $(COMPRESS) Lemurien1.0.0.tar) && $(MOVE) `dirname .obj/Lemurien1.0.0`/Lemurien1.0.0.tar.gz . && $(DEL_FILE) -r .obj/Lemurien1.0.0
