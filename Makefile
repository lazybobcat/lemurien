...
# Generated by qmake (3.0) (Qt 5.0.2) on: sam. févr. 15 00:20:14 2014
...
dist: 
	@test -d .obj/1.0.0 || mkdir -p .obj/1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/1.0.0/ && $(COPY_FILE) --parents resources.qrc .obj/1.0.0/ && $(COPY_FILE) --parents QtSingleApplication/qtsingleapplication.h QtSingleApplication/qtlocalpeer.h song.h config.h database/databasemanager.h database/sqlmodel.h database/sqlmodelfactory.h exceptions/sqlexception.h exceptions.h exceptions/sqldatabaseexception.h exceptions/sqldatanotfoundexception.h exceptions/sqlinsertfailedexception.h exceptions/logicalfaultexception.h interface/sidebar.h models/playlisttablemodel.h playlists/playlist.h playlists/unsavabeplaylist.h utilities/factory.h windows/addfileswindow.h windows/editsongwindow.h windows/mainwindow.h windows/webkitwindow.h .obj/1.0.0/ && $(COPY_FILE) --parents QtSingleApplication/qtsingleapplication.cpp QtSingleApplication/qtlocalpeer.cpp main.cpp song.cpp config.cpp database/databasemanager.cpp database/sqlmodelfactory.cpp database/sqlmodel.cpp exceptions/sqlexception.cpp exceptions/sqldatabaseexception.cpp exceptions/sqldatanotfoundexception.cpp exceptions/sqlinsertfailedexception.cpp exceptions/logicalfaultexception.cpp interface/sidebar.cpp models/playlisttablemodel.cpp playlists/playlist.cpp windows/addfileswindow.cpp windows/editsongwindow.cpp windows/mainwindow_ui.cpp windows/mainwindow_behaviors.cpp windows/webkitwindow.cpp .obj/1.0.0/ && (cd `dirname .obj/1.0.0` && $(TAR) 1.0.0.tar 1.0.0 && $(COMPRESS) 1.0.0.tar) && $(MOVE) `dirname .obj/1.0.0`/1.0.0.tar.gz . && $(DEL_FILE) -r .obj/1.0.0
